...
public class UserInfoController {
    ...
    @GetMapping("/profile")
    public ApiResponse<UserInfoResponse> getMyProfile(@AuthenticationPrincipal CustomUserDetails userPrincipal) {
        User user = userServiceLogin.getAuthenticatedUser(userPrincipal.getProviderId());
    ...
    public ResponseEntity<UserMileageResponse> getMyMileage(@AuthenticationPrincipal CustomUserDetails userPrincipal) {
        User user = userServiceLogin.getAuthenticatedUser(userPrincipal.getProviderId());
        UserMileageResponse response = userService.getUserMileage(user.getId());
    ...
    @PostMapping("/address")
    public ApiResponse<AddressResponse> getMyAddress(@AuthenticationPrincipal CustomUserDetails userPrincipal,
                                                        @RequestBody AddressRequest request) {
        AddressResponse addressResponse = userAddressService.saveAddress(userPrincipal.getProviderId(), request);
