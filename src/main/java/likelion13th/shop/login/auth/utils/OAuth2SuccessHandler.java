...
public class OAuth2SuccessHandler implements AuthenticationSuccessHandler {
    ...
    private final UserServiceLogin userService;                     // JWT 발급 및 RefreshToken 저장 로직

    private static final List<String> ALLOWED_ORIGINS = List.of(
            "https://dylan-perfume.netlify.app",
            "http://localhost:3000"
    );
    private static final String DEFAULT_FRONT_ORIGIN = "https://dylan-perfume.netlify.app";
